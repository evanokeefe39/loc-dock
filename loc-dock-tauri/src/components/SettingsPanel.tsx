    ...
    <div className="settings-overlay">
      ...
      <div className="settings-scroll">
        ...
        <div className="settings-sources-gallery">
          ...
          {/* Add Source card */}
          <div className="settings-source-card settings-add-card" onClick={() => setShowAddSource(true)}>
            <div className="settings-source-add-icon">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            </div>
          ...
          {settings.data_sources && settings.data_sources.map(source => (
            <div key={source.id} className="settings-source-card">
              ...
              <div className="settings-source-card-body">
                <span className="settings-source-card-name">{source.display_name}</span>
                <div className="settings-source-card-actions">
                  <button className="settings-card-btn" onClick={() => setEditingSource(source)} title="Edit"><Pencil size={13} /></button>
                  <button className="settings-card-btn settings-card-btn-del" onClick={() => handleRemoveSource(source.id)} title="Remove"><Trash2 size={13} /></button>
                </div>
              </div>
            </div>
          ))}
