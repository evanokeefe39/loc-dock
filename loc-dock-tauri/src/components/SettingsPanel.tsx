        ...
        <div className="settings-sources-gallery">
          ...
          {settings.data_sources && settings.data_sources.map(source => (
            <div key={source.id} className="settings-source-card">
              <div className="settings-source-card-top">
              ...
              <div className="settings-source-card-actions">
                <button className="settings-card-btn" onClick={() => setEditingSource(source)} title="Edit"><Pencil size={12} /></button>
                <button className="settings-card-btn settings-card-btn-del" onClick={() => handleRemoveSource(source.id)} title="Remove"><Trash2 size={12} /></button>
              </div>
            </div>
          ))}
          ...
          <div className="settings-source-card settings-add-card" onClick={() => setShowAddSource(true)}>
            ...
            <span className="settings-add-card-text">Add Source</span>
          </div>
        </div>
        {editingSource && (
